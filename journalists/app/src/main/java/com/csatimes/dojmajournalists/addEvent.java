 ...
 //   SaveData saveData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void AddData() {
            ...
            Toast.makeText(addEvent.this, "Added to Events!", Toast.LENGTH_SHORT).show();
    ...
    public void setTimePickerDialog(){
        ...
        event_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final TimePickerDialog tpd = new TimePickerDialog(addEvent.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
